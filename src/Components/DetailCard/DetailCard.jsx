  ...
  return (
    <>
      {dentista.nome !== undefined ? (
        <>
          <h1>Detalhes do Dr.: {dentista.nome} </h1>
            ...
            <div className={`card-body row ${theme}`}>
              ...
              <div className="col-sm-12 col-lg-6">
                <ul className="list-group">
                  ...
                  <li className="list-group-item"> Usuário: {dentista.usuario.username}</li>
                </ul>
                <div className="text-center">
                  <button data-bs-toggle="modal" data-bs-target="#exampleModal" className={`btn btn-light ${styles.button}`}>Agendar consulta</button>
                </div>
              </div>
            </div>
          </section>
